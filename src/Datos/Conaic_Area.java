...
public class Conaic_Area {
    ...
    public ResultSet DataSetConaic_Areas() throws SQLException
    {
        ...
        "Conaic_Area.subsubarea AS SubSubArea, Conaic_Area.nombre AS Nombre, " +
        "Conaic_Area.clave AS clave, Conaic_Area.descripcion AS descripcion " +
        "FROM Conaic_Area " +
        "ORDER BY Conaic_Area.area, Conaic_Area.subarea, Conaic_Area.subsubarea";
        this.bd.ejecutarSQL(sql);        
       ...
       public ResultSet DataSetConaic_Areas(String patron, int campo)
    {
        ...
        String order;
        order =  " ORDER BY Conaic_Area.area, Conaic_Area.subarea,Conaic_Area.subsubarea";  
