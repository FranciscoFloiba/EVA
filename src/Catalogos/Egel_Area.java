...
public class Egel_Area extends javax.swing.JDialog {
   ...
   private void EstadoPanel(Container c, boolean estado)
   {
    ...
    private void initComponents() {
        ...
        jToolBar1.setBounds(0, 0, 100, 490);
        ...
        nombre.setBounds(140, 300, 430, 28);
        ...
        boton_guardar.setBounds(300, 440, 130, 40);
        ...
        boton_cancelar.setBounds(440, 440, 130, 40);
        ...
        jScrollPane1.setBounds(140, 360, 430, 60);
        ...
        panelarea.setBounds(140, 90, 440, 60);
        ...
        panelsubarea.setBounds(140, 150, 440, 60);
        ...
        panelsubsubarea.setBounds(140, 210, 440, 60);

        menucaptura.setBackground(new java.awt.Color(153, 153, 153));
        getContentPane().add(menucaptura);
        menucaptura.setBounds(0, 0, 100, 500);

        setSize(new java.awt.Dimension(631, 534));
